...
few clicks. See the [Dev Environment Setup](Getting-Started/setting-up-metasploit-dev-enviroment.html) if you'd like to deal with dependencies on your own.
